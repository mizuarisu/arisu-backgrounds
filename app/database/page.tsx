...
export default function DatabasePage() {
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', position: 'relative', overflow: 'hidden' }}>
      <div className="blob" style={{ width: 360, height: 360, background: 'var(--lavender-light)', opacity: 0.3, top: -100, right: -80 }} />
      <div className="blob" style={{ width: 280, height: 280, background: 'var(--pink)', opacity: 0.3, top: 200, left: -100, animationDelay: '3s' }} />
